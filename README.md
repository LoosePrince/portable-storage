...
你需要使用一个下届之星才能启用完整仓库（可配置）

于1.4.6起，你还可以使用海洋之心来激活一个初级的仓库，它被限制为可以存放46种物品，堆叠数不限，同时一些升级功能将无法使用，此外和完整仓库没有区别

初级仓库中被限制的功能：绑定木桶、裂隙（龙蛋）、光灵箭、附魔之瓶、活塞。

## 模组UI

![](docs/img/02-v1.4.6.png)
...
- **Minecraft 版本**：
  - 1.20.1：测试版本，可能存在未测试的问题（已知问题：背包界面搜索栏无法显示和使用）
  - 1.21
  - 1.21.1
