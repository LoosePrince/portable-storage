...
public class RiftUpgrade extends UpgradeType {
    public static final ResourceLocation ID = PortableStorage.id("rift");
    public static final ResourceLocation ICON = PortableStorage.id("textures/gui/upgrade/rift.png");
