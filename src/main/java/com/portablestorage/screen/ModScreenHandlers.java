...
public class ModScreenHandlers {
    public static final MenuType<CraftingWarehouseScreenHandler> CRAFTING_WAREHOUSE = new MenuType<>(
            CraftingWarehouseScreenHandler::new, net.minecraft.world.flag.FeatureFlags.VANILLA_SET);
