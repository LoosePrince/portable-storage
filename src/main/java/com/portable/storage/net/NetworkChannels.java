...
public final class NetworkChannels {
	...
	public static void registerCodecs() {
		...
		PayloadTypeRegistry.playC2S().register(SyncBarrelFilterRulesC2SPayload.ID, SyncBarrelFilterRulesC2SPayload.CODEC);
		...
		PayloadTypeRegistry.playS2C().register(OpenBarrelFilterS2CPayload.ID, OpenBarrelFilterS2CPayload.CODEC);
	}
}